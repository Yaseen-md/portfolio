      ...
      {project && (
        ...
        >
          <motion.div
            ...
            className="bg-[#0a0a0a] w-full max-w-3xl rounded-2xl overflow-hidden glass-border shadow-2xl"
          ...
          >
            <div className="relative h-64 md:h-80">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="absolute top-4 right-4 bg-white/10 backdrop-blur-md rounded-full text-white hover:bg-white/20"
                onClick={onClose}
